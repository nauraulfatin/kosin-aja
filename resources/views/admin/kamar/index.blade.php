<x-admin-layout>
    ...
    @if(session('success'))
    <div
        style="background:#dcfce7;color:#16a34a;padding:12px 16px;border-radius:8px;margin-bottom:16px;font-size:0.9rem;">
        {{ session('success') }}
    </div>
    @endif
        ...
        <table class="w-full text-sm border-collapse">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-100 last:border-0">
                    ...
                    <td class="py-4 px-4 text-center text-gray-600">Rp. {{ number_format($kamar->harga, 0, ',', '.') }}
                    </td>
                    <td class="py-4 px-4 text-center">
                        @if($kamar->status == 'terisi')
                        <span
                            style="display:inline-block;background:#d1fae5;color:#059669;font-size:12px;font-weight:600;padding:4px 14px;border-radius:20px;">
                            Terisi
                        </span>
                        @else
                        <span
                            style="display:inline-block;background:#e0f2fe;color:#0284c7;font-size:12px;font-weight:600;padding:4px 14px;border-radius:20px;">
                            Kosong
                        </span>
                        @endif
                    </td>
                ...
                @empty
                <tr>
                    <td colspan="6" class="py-10 text-center text-gray-400">Belum ada kamar. Klik tombol Tambah Kamar
