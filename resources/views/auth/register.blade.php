<x-guest-layout>
    <div class="flex min-h-screen bg-[#FDFAF4]">
        ...
        <div class="w-full lg:w-3/4 flex items-center justify-center px-10 py-12">
            <div class="w-full max-w-lg">
                ...
                <p class="text-lg text-gray-500 mb-8">Daftarkan kos Anda dan mulai kelola penghuni dengan lebih praktis
                </p>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="flex gap-4 mb-4">
                        ...
                        <div class="flex-1">
                            ...
                            <x-text-input id="phone"
                                class="block w-full border border-gray-300 rounded-lg px-4 py-3 text-base focus:ring-[#6C8B6B] focus:border-[#6C8B6B]"
                                type="text" name="phone" :value="old('phone')" placeholder="No. Telp" />
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="nama_kos"
                            class="block w-full border border-gray-300 rounded-lg px-4 py-3 text-base focus:ring-[#6C8B6B] focus:border-[#6C8B6B]"
                            type="text" name="nama_kos" :value="old('nama_kos')" required placeholder="Nama Kos" />
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="alamat_kos" name="alamat_kos" rows="3" placeholder="Alamat Kos"
                            class="block w-full border border-gray-300 rounded-lg px-4 py-3 text-base focus:ring-[#6C8B6B] focus:border-[#6C8B6B] resize-none">{{ old('alamat_kos') }}</textarea>
                    ...
                    <div class="mb-6 relative">
                        <x-input-label for="password_confirmation" :value="__('Confirm Password')"
                            class="text-s text-gray-500 mb-1" />
                        <div class="relative">
        ...
        <div class="hidden lg:block w-2/4">
            <div class="sticky top-0 h-screen">
                <img src="{{ asset('pintu-login.png') }}" alt="KosinAja!" class="w-full h-full object-cover">
            </div>
        </div>
    ...
    <div id="modal-berhasil" class="fixed inset-0 flex items-center justify-center z-50">
        ...
        {{-- Modal Box --}}
        <div
            class="relative bg-[#FDFAF4] rounded-2xl shadow-xl px-10 py-10 w-80 flex flex-col items-center text-center">

            {{-- Icon Centang --}}
            <div class="bg-[#D6E5D6] rounded-full p-5 mb-4 relative">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-[#6C8B6B]" fill="none" viewBox="0 0 24 24"
            ...
            {{-- Tombol Oke --}}
            <button onclick="document.getElementById('modal-berhasil').style.display='none'"
